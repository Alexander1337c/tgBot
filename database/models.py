from sqlalchemy import String, Float, DateTime, func, Numeric, ForeignKey, BigInteger
...
class Account(Base):
    ...
    limit: Mapped[float] = mapped_column(Numeric(5,2), nullable=True)
    balance: Mapped[float] = mapped_column(Numeric(5,2), nullable=True, default=0)
...
class Transaction(Base):
    ...
    amount: Mapped[int] = mapped_column(Numeric(5, 2), nullable=False)
